...
const apiLimiter = rateLimit({
  ...
  max: process.env.NODE_ENV === 'test' ? 10000 : 10000, // Limit each IP to 10000 requests per windowMs
...
const authLimiter = rateLimit({
  windowMs: 15 * 60 * 1000, // 15 minutes
  max: process.env.NODE_ENV === 'test' ? 10000 : 100, // Limit each IP to 100 requests per windowMs (e.g. login attempts)
